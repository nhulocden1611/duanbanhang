        ...
        <c:forEach var="hoaDon" items="${hoaDonList}">
            <tr>
                ...
                <td class="table-active">
                    <c:set var="tongDonGia" value="0" /> <!-- Khởi tạo biến tổng đơn giá -->
                    <c:forEach var="hdct" items="${hoaDon.hoaDonChiTietList}">
                        <c:set var="donGia" value="${hdct.donGia * hdct.soLuong}" />
                        <c:set var="tongDonGia" value="${tongDonGia + donGia}" />
                    </c:forEach>
                    <strong>${tongDonGia}</strong> VND <!-- Hiển thị tổng đơn giá -->
                </td>
